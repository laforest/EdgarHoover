...
def robot_status(OI, SRL, SRR):
    ...
    print("Battery Voltage Current Temp Charge Capacity: {0} {1} {2} {3} {4}".format(OI.Battery_Voltage(), OI.Battery_Current(), OI.Battery_Temperature(), OI.Battery_Charge(), OI.Battery_Capacity()))
